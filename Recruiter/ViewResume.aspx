<%@ Page Title="" Language="C#" MasterPageFile="~/Recruiter/Recruiter.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ViewResume.aspx.cs" Inherits="WebApplicationChanges.Recruiter.ViewResume"  %>
            ...
            <div class="row mb-3 pt-sm-3">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No records to display" AutoGenerateColumns="False" PageSize="5"
                        OnPageIndexChanging="GridView1_PageIndexChanging1" DataKeyNames="AppliedJobId" OnRowDeleting="GridView1_RowDeleting1" OnRowDataBound="GridView1_RowDataBound1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1"> 
