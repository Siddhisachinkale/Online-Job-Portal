...
namespace WebApplicationChanges.Admin
{
    public partial class RecruiterList : System.Web.UI.Page
    {
        ...
        private void ShowUsers()
        {
            ...
            query = @"select Row_Number() over(Order by (Select 1)) as Sr_No,UserId, Name, Email, Mobile from Recruiter;";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                con = new MySqlConnection(str);
                cmd = new MySqlCommand("delete from Recruiter where UserId=@id", con);
