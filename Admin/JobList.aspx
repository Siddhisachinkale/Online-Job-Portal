<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="JobList.aspx.cs" Inherits="WebApplicationChanges.Admin.JobList" %>
                ...
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No records to display" AutoGenerateColumns="False" PageSize="5"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="RecruiterName" HeaderText="RecruiterName">
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
