<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="joblisting.aspx.cs" Inherits="WebApplicationChanges.User.joblisting" %>
<%--<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>--%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/fontawesome.css"
        ...
        .checkbox {
            ...
            .checkbox label {
                ...
                .checkbox label::before {
                    ...
                    -webkit-transition: border 0.15s ease-in-out, color 0.15s ease-inout;
                                ...
                                <div class="small-section-tittle2 mb-45">
                                    <div class="ion">
                                        <svg
                                            ...
                                            <path fill-rule="evenodd" fill="rgb(27,
207, 107)"
                               ...
                               <%-- <!-- Select job items start -->
                                <div class="select-job-items2">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1"
                                        runat="server" ConnectionString="<%$ ConnectionStrings:LocalMysql %>"
                                        SelectCommand="SELECT [CountryName] FROM
                                            ...
                                            <div class="job-items">
                                                ...
                                                <div class="job-tittle job-tittle2">
                                                    ...
                                                    <ul>
                                                        ...
                                                        %></li>
                                                        <li>
                                                       <i class="fas fa-mapmarker-alt">
                                                          </i><%--<%# Eval("State") %>, <%# Eval("Country") %>--%>
                                                            </li>
                                                        <li><%# Eval("Salary") %></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="items-link items-link2 fright">
