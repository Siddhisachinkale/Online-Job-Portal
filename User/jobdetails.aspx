<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="jobdetails.aspx.cs" Inherits="WebApplicationChanges.User.jobdetails" %>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="post-details4  mb-50">
                           ...
                           <div class="small-section-tittle">
                              ...
                              <p>Address : <%# Eval("Address") %> And Contact Us : <%# Eval("Email") %></p>
                            <ul>
                                <li>Name: <span><%# Eval("CompanyName") %></span></li>
                                <li>Web : <span><%# Eval("Website") %></li>
